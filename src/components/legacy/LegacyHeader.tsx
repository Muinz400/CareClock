...
/*
  Extracted verbatim from src/app/layout.tsx as part of the Operations Deck
  shell migration (Step 1 — transitional chrome strategy). This is exactly
  what production rendered around every route before this step; zero visual
  or behavioral change. Used only by LegacyChromeGate for routes that have
  not yet migrated into their own (public)/(admin)/(caregiver) route-group
  layout. Deleted once every route has migrated — see the migration plan.
*/
